// import Java's Scanner class to retrieve user input.
...
public class PeopleWeights {
    ...
    public static void main(String[] args) {
         ...
         * simple through only needing to change one line of code.
         ...
         * initialize it to 0.0. 
         * Declare the maxWeight double to capture the max input value and
         * initialize it to 0.0. 
         */
        
        Scanner scnr = new Scanner(System.in);
        final int NUM_OF_ELEMENTS = 5; 
        // The array assignment calls for an array of type double with length NUM_OF_ELEMENTS.
         ...
         * five times, so the number of iterations is known (i.e. the array length).  
         * A for loop should therefore be used in lieu of a while loop.
         ...
         * The divisor should be the length of the array to ensure it's reflective
         * of the true average if the array's size is changed above
         * by modifying the value assigned to NUM_OF_ELEMENTS.
         */
